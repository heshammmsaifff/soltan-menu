...
export default function Milkshake() {
  const items = [
    { name: "آيس لاتيه", sizes: [{ price: 40 }] },
    { name: "آيس كابتشينو", sizes: [{ price: 45 }] },
    { name: "آيس موكا", sizes: [{ price: 45 }] },
    { name: "آيس شوكليت", sizes: [{ price: 45 }] },
    { name: "آيس فرابتشينو", sizes: [{ price: 45 }] },
  ];
