...
export default function Waffle() {
  const items = [
    { name: "وافل شوكليت", sizes: [{ price: 40 }] },
    { name: "وافل نوتيلا", sizes: [{ price: 40 }] },
    { name: "وافل لوتس", sizes: [{ price: 40 }] },
    { name: "وافل كراميل", sizes: [{ price: 40 }] },
    { name: "وافل بتساشيو", sizes: [{ price: 50 }] },
    { name: "وافل وايت شوكليت", sizes: [{ price: 40 }] },
    { name: "وافل ميكس", sizes: [{ price: 50 }] },
  ];
