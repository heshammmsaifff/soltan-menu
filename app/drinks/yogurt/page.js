...
export default function Yogurt() {
  const items = [
    { name: "زبادي عسل", sizes: [{ price: 40 }] },
    { name: "زبادي فراولة", sizes: [{ price: 40 }] },
    { name: "زبادي توت أزرق", sizes: [{ price: 40 }] },
    { name: "زبادي توت أحمر", sizes: [{ price: 40 }] },
    { name: "زبادي مانجو", sizes: [{ price: 40 }] },
  ];
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#5C3A1A] to-[#CBA34A] p-6 text-right flex flex-col gap-8">
      ...
      <div
        className="bg-black text-white w-[316px] h-[51px] text-center items-center flex justify-between mx-auto"
        dir="rtl"
      >
        <p className="mr-[34px]">متوفر جميع أنواع التوبينج علي زبادي</p>
      </div>
      <Link
        href="/drinks"
